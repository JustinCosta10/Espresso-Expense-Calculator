...
The program can run with more or less people by modifying orderdata.csv, but adding people after orders have been placed will not work fairly cost wise.
